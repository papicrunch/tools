...
rem Arnold var
rem set "HTOA_BIN=X:\_MTC_CONFIG\_CONFIG_HOUDINI_\htoa\Htoa_2.24\htoa-2.2.4_re18b644_houdini-16.5.405\scripts\bin"
rem set "HTOA_PATH=X:\_MTC_CONFIG\_CONFIG_HOUDINI_\htoa\Htoa_2.24\htoa-2.2.4_re18b644_houdini-16.5.405\"
...
rem set "HOUDINI_PATH=%HTOA_PATH%;%HOUDINI_GAMEDEV%;&;%HOUDINI_HMTC%"
set "HOUDINI_PATH=%HOUDINI_GAMEDEV%;&;%HOUDINI_HMTC%"
set "HOUDINI_DIR=C:\Program Files\Side Effects Software\%HOUDINI_VERSION%\bin"
rem set "PATH=%HTOA_BIN%;%HOUDINI_DIR%;%PATH%"
